...
import { parentLoginLimiter,parentRegisterLimiter,parentLinkCodeLimiter,parentLinkAttemptLimiter,parentForgotPasswordLimiter,parentResetPasswordLimiter,parentEmailVerificationAttemptLimiter,parentEmailVerificationResendLimiter} from "../Middleware/rateLimit.Middleware.js";
...
route.post("/parent/verify-email",parentEmailVerificationAttemptLimiter,verifyParentEmailController);
route.post("/parent/resend-verification-code",parentEmailVerificationResendLimiter,resendParentVerificationCodeController);
route.post("/parent/forgot-password", parentForgotPasswordLimiter,parentForgotPasswordController);
route.post("/parent/reset-password",parentResetPasswordLimiter,parentResetPasswordController);
