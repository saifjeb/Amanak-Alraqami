...
import { adminForgotPasswordController,adminResetPasswordController, } from "../Controller/passwordReset.Controller.js";
...
import {disableStudentController,enableStudentController,permanentlyDeleteStudentController} from "../Controller/adminStudentManagement.Controller.js";
import {adminLoginLimiter,adminForgotPasswordLimiter,adminResetPasswordLimiter} from "../Middleware/rateLimit.Middleware.js";
...
router.post("/forgot-password",adminForgotPasswordLimiter,adminForgotPasswordController);
router.post("/reset-password",adminResetPasswordLimiter,adminResetPasswordController);
...
router.delete("/students/:id/permanent",protectAdmin,validateIdParam("id", "student ID"),permanentlyDeleteStudentController);
